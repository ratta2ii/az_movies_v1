...
function LocationsDropdown() {
    ...
    return (
        <>
            <Button sx={{ color: '#fff', mx: 1 }} onClick={handleClick}>
                Locations
            </Button>
            <Menu
                anchorEl={anchorEl}
            ...
            >
                <MenuItem onClick={handleClose} component={Link} to="/mesa">Mesa</MenuItem>
                <MenuItem onClick={handleClose} component={Link} to="/scottsdale">Scottsdale</MenuItem>
                <MenuItem onClick={handleClose} component={Link} to="/tempe">Tempe</MenuItem>
                <Divider />
                <MenuItem onClick={handleClose} component={Link} to="/locations">Other Locations</MenuItem>
            </Menu>
        </>
    );
}
        ...
        <nav onClick={handleDrawerToggle} style={{ textAlign: 'center', backgroundColor: '#ffffff' }}>
            ...
            <Box sx={{ backgroundColor: '#f5f5f5' }}>
                <List disablePadding>
                    ...
                    <ListItem disablePadding disableGutters sx={{ padding: 0, margin: 0 }}>
                        <Link to='/service-areas' style={{ textDecoration: 'none', width: '100%' }}>
                            <ListItemButton
                                style={{
                                    textAlign: 'center',
                                    borderLeft: ['/service-areas', '/athol', '/blanchard', '/coeur-d-alene', '/kellogg', '/plummer', '/post-falls', '/priest-river', '/rathdrum', '/sandpoint', '/spirit-lake', '/deer-park', '/newport', '/spokane', '/benewah-county', '/bonner-county', '/kootenai-county', '/pend-oreille-county', '/spokane-county'].some(route => location.pathname.startsWith(route)) ? '8px solid red' : '8px solid transparent',
                                    backgroundColor: ['/service-areas', '/athol', '/blanchard', '/coeur-d-alene', '/kellogg', '/plummer', '/post-falls', '/priest-river', '/rathdrum', '/sandpoint', '/spirit-lake', '/deer-park', '/newport', '/spokane', '/benewah-county', '/bonner-county', '/kootenai-county', '/pend-oreille-county', '/spokane-county'].some(route => location.pathname.startsWith(route)) ? '#e0e0e0' : 'transparent',
                                    padding: '25px 20px',
                                    textTransform: 'none',
                                }}
                            >
                ...
                {isMobile ? (
                    ...
                    <Toolbar>
                        ...
                        <Box sx={{ display: 'flex' }}>
                            ...
                            <LocationsDropdown />
                            <Link to='/faqs'>
                                <Button sx={{ color: '#fff', mx: 1 }}>FAQs</Button>
                            </Link>
                            <Link to='/gallery'>
                                <Button sx={{ color: '#fff', mx: 1 }}>Gallery</Button>
                            </Link>
                            <Link to='/contact'>
